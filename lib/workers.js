...
workers.validateCheckData=function(ogCheckData){
    ...
    ogCheckData.userPhone=typeof(ogCheckData.userPhone)=='string'&&ogCheckData.userPhone.trim().length==10?ogCheckData.userPhone:false;
